#This file comes from Juneja, R. (2016, January 5). Ball Tracking Robot. Retrieved September 19, 2020, 
# from https://create.arduino.cc/projecthub/junejarohan/ball-tracking-robot-7a9865?ref=user

#This file is related to the camera and all kinds of sensor which they would be using in the future project
#This file was written by the Rasperry Pi
